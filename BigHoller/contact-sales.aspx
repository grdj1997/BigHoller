                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <h1 class="h2 mb-4">BigHoller can boost your business. We'll tell you how.</h1>
                            <h2 class="font-18 text-gray-1 mb-5">Let's set up a time to discuss your business needs and how to use BigHoller as an integral part of your success.</h2>

                            <ul class="list-unstyled font-17 text-gray-2">
                                <li class="mb-3">Powerful Restaurant App</li>
                                <li class="mb-3">Cloud-based access and convenience</li>
                                <li class="mb-3">Everything a restaurant needs</li>
                                <li class="mb-3">Analytics to show your growth and success</li>
                            </ul>
                        </div>
                        ...
                        <div id="ContactSupport" class="col-xs-12 col-sm-6 mb-3">
                            <form class="col-12 pl-0 pr-0" name="basicform" id="basicform1" method="post" action="thankyou.aspx">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" placeholder="Restaurant Name" id="Restaurant" name="Restaurant" class="form-control form-control-lg" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" placeholder="Name a couple of good times to talk or if there is something else on your mind?" id="Description" name="Description" rows="4" class="form-control" autocomplete="off"></textarea>
                                    </div>

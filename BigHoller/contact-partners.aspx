                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 mb-3">
                            <h1 class="h2">BigHoller is looking for partners where the relationship can be mutually beneficial.</h1>
                        </div>
                        ...
                        <div id="ContactSupport" class="col-xs-12 col-sm-6 mb-3">
                            <form class="col-12 pl-0 pr-0" name="basicform" id="basicform1" method="post" action="thankyou.aspx">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input type="text" placeholder="Company" id="Company" name="Company" class="form-control form-control-lg" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" placeholder="How can we partner up?" id="Description" name="Description" rows="4" class="form-control" autocomplete="off"></textarea>
                                    </div>

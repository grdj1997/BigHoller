        ...
        <div class="wrapper">
            ...
            <section id="main-body" class="text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="h2 text-blue poppins-medium">Thank you <%= FirstName %>, welcome to BigHoller!</h1>
                            <h2 class="h3">Someone will be getting back to you shortly.</h2>
                            <h2 class="h3">It all starts with a restaurant app.</h2>
                        </div>
                    </div>
                </div>
            </section>

            <section class="background-gray-1"></section>

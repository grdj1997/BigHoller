                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 mb-3">
                            <h1 class="h2">What support to you need?</h1>
                        </div>
                        ...
                        <div id="ContactSupport" class="col-xs-12 col-sm-6 mb-3">
                            <form class="col-12 pl-0 pr-0" name="basicform" id="basicform1" method="post" action="thankyou.aspx">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" placeholder="What support do you need?" id="Description" name="Description" rows="4" class="form-control" autocomplete="off"></textarea>
                                    </div>
